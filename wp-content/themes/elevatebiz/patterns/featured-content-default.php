 ...
 * Slug: elevatebiz/featured-content-default
...
<div class="wp-block-group alignfull wp-block-section wp-block-feature-content-default">
	...
	<div class="wp-block-group alignwide wp-block-group-heading">
		...
		<h2 class="wp-block-heading has-text-align-center has-product-heading-font-size"><?php esc_html_e('Featured Content', 'elevatebiz'); ?></h2>
		<!-- /wp:heading -->
		...
		<div class="wp-block-columns alignwide">
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group wp-block-post-group">
					...
					<div class="wp-block-group wp-block-entry-content">
						...
						<h2 class="has-content-heading-font-size"><?php esc_html_e('Creative Design', 'elevatebiz'); ?></h2>
						<!-- /wp:heading -->
						<!-- wp:paragraph -->
						<p><?php esc_html_e('Lorem ipsum dolor sit amet consecte tur adipiscing elit integer fermentum in orci lorem ipsum.', 'elevatebiz'); ?></p>
						<!-- /wp:paragraph -->
						<!-- wp:buttons -->
						<div class="wp-block-buttons">
							...
							<div class="wp-block-button is-style-outline is-style-only-line">
								<a class="wp-block-button__link"><?php esc_html_e('Read More', 'elevatebiz'); ?></a>
							</div>
							<!-- /wp:button -->
						</div>
						<!-- /wp:buttons -->
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group wp-block-post-group">
					...
					<div class="wp-block-group wp-block-entry-content">
						<!-- wp:heading {"fontSize":"content-heading"} -->
						<h2 class="has-content-heading-font-size"><?php esc_html_e('Full Site Editing', 'elevatebiz'); ?></h2>
						<!-- /wp:heading -->
						<!-- wp:paragraph -->
						<p><?php esc_html_e('Lorem ipsum dolor sit amet consecte tur adipiscing elit integer fermentum in orci lorem ipsum.', 'elevatebiz'); ?></p>
						<!-- /wp:paragraph -->
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group wp-block-post-group">
					...
					<div class="wp-block-group wp-block-entry-content">
						<!-- wp:heading {"fontSize":"content-heading"} -->
						<h2 class="has-content-heading-font-size"><?php esc_html_e('Clean Codes', 'elevatebiz'); ?></h2>
						<!-- /wp:heading -->
						<!-- wp:paragraph -->
						<p><?php esc_html_e('Lorem ipsum dolor sit amet consecte tur adipiscing elit integer fermentum in orci lorem ipsum.', 'elevatebiz'); ?></p>
						<!-- /wp:paragraph -->
